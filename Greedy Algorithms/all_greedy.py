...
print("sorting by weight = " + str(greedy_weight(data, maxWeight)))
print("sorting by value = " + str(greedy_value(data, maxWeight)))
print("sorting by value:weight ratio = " + str(greedy_ratio(data, maxWeight)))